...
import static com.watabou.noosa.Game.width;
...
import com.shatteredpixel.shatteredpixeldungeon.ui.changelist.Star_v0_1_X_Changes;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				Star_v0_1_X_Changes.addAllChanges(changeInfos);
				break;
			case 1:
		...
		StyledButton btn1_1 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "Star PD"){
			@Override
		...
		btn1_1.setRect(list.left()-4f, list.bottom(), wid/2, changesSelected == 0 ? 19 : 15);
		addToBack(btn1_1);

		StyledButton btn0_9 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "0.9-1.X"){
			@Override
			protected void onClick() {
				super.onClick();
		...
		btn0_9.setRect(btn1_1.right()+1, list.bottom(), wid/2, changesSelected == 1 ? 19 : 15);
		addToBack(btn0_9);
