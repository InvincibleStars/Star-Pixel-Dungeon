...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		btnAbout.icon(Icons.get(Icons.ENERGY/*NEWS*/));
		add(btnAbout);
		...
		if (landscape()) {
			...
			//第二行
			btnRankings.setRect(btnPlay.left(), btnPlay.bottom()+ GAP, (btnPlay.width()/2f)-1, BTN_HEIGHT);

			btnChanges.setRect(btnRankings.right()+2, btnPlay.bottom()+ GAP, (btnPlay.width()/2f)-1, BTN_HEIGHT);

			//第三行
			btnBadges.setRect(btnRankings.left(), btnRankings.bottom() + GAP, btnRankings.width(), BTN_HEIGHT);

			btnSettings.setRect(btnChanges.left(), btnRankings.bottom() + GAP, btnRankings.width(), BTN_HEIGHT);

			//第四行
			btnAbout.setRect(btnBadges.left(), btnSettings.bottom() + GAP, btnPlay.width(), BTN_HEIGHT);
		} else {
			btnPlay.setRect(title.x, topRegion+GAP, title.width(), BTN_HEIGHT);
			align(btnPlay);
			btnPlay.setRect(btnPlay.left(), btnPlay.bottom()+ GAP, btnPlay.width(), BTN_HEIGHT);
			//第二行
			btnRankings.setRect(btnPlay.left(), btnPlay.bottom()+ GAP, (btnPlay.width()/2f)-1, BTN_HEIGHT);
