...
public class KillBust extends NPC {
											   ...
											   protected void onSelect(int index) {
												   ...
												   if (index == 0) {
													   if(!Badges.isUnlocked(Badges.Badge.MONSTERS_SLAIN_1)){
														   GLog.n(Messages.get(KillBust.class, "empty")+"\n");
													   }
													   ...
													   if (Badges.isUnlocked(Badges.Badge.MONSTERS_SLAIN_1)) {
														   ...
														   GLog.i(Messages.get(KillBust.class, "weapon")+"\n");
													   }
													   ...
													   //给予完毕后才会锁定
													   GLog.i(Messages.get(KillBust.class, "killopen")+"\n");
													   NPC.choose=true;
													   NPC.choose_num=1;
												   } else {
													   GLog.i(Messages.get(KillBust.class, "noselect"));
