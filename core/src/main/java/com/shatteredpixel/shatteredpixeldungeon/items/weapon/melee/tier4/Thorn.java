...
public class Thorn extends MeleeWeapon {

	{
		image = ItemSpriteSheet.THORN;
	...
	public int damageRoll(Char attacker, Char defender, int damage) {
		...
		return super.damageRoll(defender);
	}
