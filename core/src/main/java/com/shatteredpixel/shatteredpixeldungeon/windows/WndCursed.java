...
public class WndCursed extends Window {
	...
	public WndCursed(Image icon, String title, String message, String... options) {
		super();
	...
	public WndCursed(String title, String message, String... options ) {
		super();
