...
public class WndOptionsNo extends Window {
	...
	public WndOptionsNo(Image icon, String title, String message, String... options) {
		super();
	...
	public WndOptionsNo(String title, String message, String... options ) {
		super();
