...
public class CrystalFlower extends Plant {
	...
	public void activate( Char ch ) {
		if (ch == Dungeon.hero) {
			Buff.affect(ch, CrystalShield.class).reset();
	...
	public static class Seed extends Plant.Seed {
		{
			image = ItemSpriteSheet.SEED_CRYSTALFLOWER;
			
			plantClass = CrystalFlower.class;
		}
	}
	
	//由水晶花瓣所所提供的效果
	
	public static class CrystalShield extends Buff {
