...
public class StatusPane extends Component {
    ...
    protected void createChildren() {
        ...
        bg = new NinePatch( Assets.Interfaces.STATUS, 0, 0, 128, 45, 85, 0, 45, 0 );
        add( bg );
        ...
        //元素条
        element = new Image( Assets.Interfaces.ELE_BAR );
        add( element );
    ...
    protected void layout() {
        ...
        hp.x = shieldedHP.x = rawShielding.x = dark.x = hg.x = wt.x = 30;
...
//		info.setPos(version.x-20, version.y+10);
    ...
    public void update() {
        ...
        //0.25
        warm.scale.y=-(0.05f * BossLoot.infection);
