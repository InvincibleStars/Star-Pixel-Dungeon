...
public class TempleAreaLevel extends RegularLevel {
	...
	protected int specialRooms(boolean forceMax) {
		...
		//2
		return 2+Random.chances(new float[]{0, 0});
	}
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.GRASS:
				return Messages.get(TempleAreaLevel.class, "grass_name");
			case Terrain.HIGH_GRASS:
				return Messages.get(TempleAreaLevel.class, "high_grass_name");
			case Terrain.WATER:
				return Messages.get(TempleAreaLevel.class, "water_name");
			default:
	...
	public String tileDesc( int tile ) {
		switch (tile) {
			case Terrain.ENTRANCE:
				return Messages.get(TempleAreaLevel.class, "entrance_desc");
			case Terrain.EXIT:
				return Messages.get(TempleAreaLevel.class, "exit_desc");
			case Terrain.HIGH_GRASS:
				return Messages.get(TempleAreaLevel.class, "high_grass_desc");
			case Terrain.WALL_DECO:
				return Messages.get(TempleAreaLevel.class, "wall_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(TempleAreaLevel.class, "bookshelf_desc");
			default:
