...
public class Temple2AreaLevel extends RegularLevel {
	...
	private static class Sink extends Emitter {
		...
		private static final Emitter.Factory factory = new Factory() {
			...
			public void emit( Emitter emitter, int index, float x, float y ) {
				SandAreaLevel.WaterParticle p = (SandAreaLevel.WaterParticle)emitter.recycle( SandAreaLevel.WaterParticle.class );
				p.reset( x, y );
			}
		};
