...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.Pot;
...
public class EntranceRoom extends StandardRoom {
	...
	@Override
	public int minWidth() {return Math.max(super.minWidth(), 8);}

	@Override
	public int maxWidth() {return Math.max(super.minWidth(), 8);}

	@Override
	public int minHeight() {return Math.max(super.minHeight(), 8);}

	@Override
	public int maxHeight() {return Math.max(super.minHeight(), 8);}
